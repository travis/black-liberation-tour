...
export default function Footer() {
  return (
    <footer className="flex flex-col lg:flex-row w-full bg-red-dark text-white">
      <div className="flex flex-col lg:w-1/3 align-bottom lg:relative p-24 md:p-10 lg:p-0 text-left sm:text-center lg:text-left">
        <span className="lg:absolute lg:left-5 lg:bottom-4 uppercase text-l font-bold" style={{ color: 'var(--pink)' }}>

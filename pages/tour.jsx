...
export default class Tour extends Component {
  ...
  render() {
    return (
      <div className="<Tour> w-full h-full">
        <main className="flex flex-col lg:flex-row min-w-full min-h-full">
          ...
          <div className="flex flex-col sm:flex-row lg:w-2/3 min-h-0">
            ...
            {/* LINKS /////////////////////////////////////////////////////////////// */}
            {/* ///////////////////////////////////////////////////////////////////// */}
            <div className="flex flex-col sm:w-1/2 md:w-2/5 text-left px-24 p-24 sm:px-10 sm:p-24 bg-yellow-600 overflow-y-auto text-6xl sm:text-4xl md:text-2xl lg:text-lg">
            ...
            {/* IMAGES /////////////////////////////////////////////////////////////// */}
            {/* ////////////////////////////////////////////////////////////////////// */}
            <div className="p-10 sm:p-6 sm:w-1/2 md:w-3/5 bg-pink overflow-y-scroll">
